          ...
          <div className="bg">
            <div className="cock-basic-info">
              ...
              <img
                  ...
                  alt="Rectangle"
                  src="http://www.thecocktaildb.com/images/media/drink/vrwquq1478252802.jpg"
/>
              ...
              <div className="text-wrapper-1">Old Fashioned</div>
              <div className="text-wrapper-2">올드 패션드</div>
              <p className="text-wrapper-16">
              올드 패션드는 버번 위스키나 보드카를 베이스로 사용한다.<br/>
              간단하면서도 풍미 있는 오렌지 껍질과 비터스의 조화로운 맛이 특징이다.
            </p>
            </div>
              </div>
                ...
                <div className="indegroup">
                  <div className="overlap-2">
                    <div className="ellipse-wrapper">
                      ...
                      <div className="textWrapper">버번</div>
                      <div className="text-wrapper">1.35 oz</div>
                    </div>
                  </div>
                </div>
                <div className="indegroup">
                  <div className="overlap-2">
                    <div className="ellipse-wrapper">
                      ...
                      <div className="textWrapper">비터즈</div>
                      <div className="text-wrapper">2 dash</div>
                    </div>
                  </div>
                </div>
                <div className="indegroup">
            ...
            <div className="overlap-2">
              ...
              <div className="ellipse">
                <div className="text-wrapper-15">
                  ...
                  <p className="step">설탕 큐브와 비터를 잔에 넣고 물과함께 섞는다.
                  </p>
                  </div>
              </div>
                <div className="recipeWrapper">
                ...
                <div className="text-wrapper-15">
                  ...
                  <div className="text-wrapper-13">
                  <p className="step">설탕이 완전히 녹은 후에 얼음을 가득 채워준다.
                    </p>
                  </div>
                </div>
                <div className="recipeWrapper">
                ...
                <div className="text-wrapper-15">
                  ...
                  <div className="text-wrapper-13">
                  <p className="step">그 위에 위스키를 부어준다.
                    </p>
                  </div>
                </div>
