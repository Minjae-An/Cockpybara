...
/>
              ...
              <div className="text-wrapper-1">Martini</div>
              <div className="text-wrapper-2">마르티니</div>
              <p className="text-wrapper-16">
              마티니는 진과 베르무트를 섞은 고급스러운 칵테일이다.<br/>
              올리브나 레몬 껍질과 함께 즐기는 것이 일반적이다.
            </p>
            </div>
              </div>
                ...
                <div className="indegroup">
                  <div className="overlap-2">
                    <div className="ellipse-wrapper">
                      ...
                      <div className="textWrapper">진</div>
                      <div className="text-wrapper">0.66 oz</div>
                    </div>
                  </div>
                </div>
                <div className="indegroup">
                  <div className="overlap-2">
                    <div className="ellipse-wrapper">
                      ...
                      <div className="textWrapper">베레무트</div>
                      <div className="text-wrapper">0.33 oz</div>
                    </div>
                  </div>
                </div>
                <div className="indegroup">
                  <div className="overlap-2">
                    <div className="ellipse-wrapper">
                      ...
                      <div className="textWrapper">올리브</div>
            ...
            <div className="overlap-2">
              ...
              <div className="ellipse">
                <div className="text-wrapper-15">
                  ...
                  <p className="step">모든 재료를 섞는 잔에 넣어준다. 
                  </p>
                  </div>
              </div>
                <div className="recipeWrapper">
                ...
                <div className="text-wrapper-15">
                  ...
                  <div className="text-wrapper-13">
                  <p className="step"> 잘 섞어준 후에 잔에 따라준다.
                    </p>
                  </div>
                </div>
                <div className="recipeWrapper">
